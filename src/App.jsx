...
function Creations() {
  return (
    <section id="creations">
      <div className="container max-w-6xl px-6 m-32 mx-auto text-gray-900 md:px-0">
        {/* Our Creations */}
        <div className="flex items-center justify-center mb-20 md:justify-between">
          <h2 className="text-4xl font-light uppercase md:text-5xl">
            Our creations
          </h2>
...
function Feature() {
  return (
    <section id="feature">
      {/* Feature Container */}
      <div className="container relative flex flex-col max-w-6xl px-6 mx-auto my-32 text-gray-900 md:flex-row md:px-0">
        {/* Image */}
        <img
        ...
        />
        {/* Text Container */}
        <div className="pr-0 bg-white top-48 md:absolute md:right-0 md:py-20 md:pl-20">
          ...
          <p className="max-w-md text-center md:text-left">
            ...
            Our award-winning creations have trasformed businesses through
    ...
    <section id="hero">
      ...
      <div className="container max-w-6xl px-6 py-12 mx-auto">
        ...
        <nav className="flex items-center justify-between font-bold text-white">
          ...
          {/* Todo humburger button */}
        </nav>
        {/* todo mobile menu */}

        <div className="max-w-lg p-4 mt-32 mb-32 font-sans text-4xl text-white uppercase border-2 md:p-10 md:m-32 md:mx-0 md:text-6xl">
          Impressive Experences That Deliver
        </div>
      </div>
    </section>
  );
